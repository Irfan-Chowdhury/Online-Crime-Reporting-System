...
<section id="blog-header" class="text-center text-light">
    <div class="container">
        <div class="row">
            <div class="col pt-5">
                    <div class="display-4 text-center text-light"><strong> These Things were found</strong></div><hr>
            </div>
        </div>
    </div>
</section>
...
<section>
    <div class="container mt-5">
        <div class="row mb-5">
            <div class="col-2">
                <a href="{{route('visitor.missingOthers')}}" class="btn btn-primary"><< Missing Things</a>
            </div>
            <div class="col-10"></div>
        </div>
        <div class="row">
            @foreach ($missing_others as $missingOther)
                 @if ($missingOther->show == "public" && $missingOther->status=="found" ) 
                    <div class="col-md-4">
                        <div class="card" style="width: 18rem;">
                            <div class="work_img">
                                ...
                                <div class="card-body">
                                    ...
                                    <a class="btn btn-primary" href="{{route('visitor.foundOthers_show',$missingOther->id)}}">Details</a>
                                </div>
                            </div>
                        </div>
                    </div>
