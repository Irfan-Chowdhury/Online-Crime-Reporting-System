...
@section('title','Details Missing Things')
...
<section id="blog-header" class="text-center text-light">
    <div class="container">
        <div class="row">
            <div class="col pt-5">
                <h1 class="text-light font-weight-bold">Details Missing Things</h1>
            </div>
        </div>
    </div>
</section> 
                ...
                <div class="container">
                    <div class="card">
                        ...
                        <div class="card-body">
                            ...
                            <p class="card-text"><b>Owner Name: </b>{{$missing_other->owner_name}}</p>
                            <p class="card-text"><b>Description: </b>{{$missing_other->description}}</p>
                            <p class="card-text"><b>Address: </b>{{$missing_other->address}}</p>
